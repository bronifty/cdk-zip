...
async function createServer() {
  ...
  // const modulePath = new URL('./another-module.js', import.meta.url).href;
  // const anotherModule = await import(modulePath);

  // This would fetch the module from a CDN or other external source
  // const moduleUrl = new URL('https://cdn.example.com/modules/external-module.js', import.meta.url).href;
  // const externalModule = await import(moduleUrl);

  const registerFastify = await import("./registerFastify.js");
